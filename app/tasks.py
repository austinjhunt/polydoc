# """ Celery tasks - asynchronous processes e.g. for progress bars; not using for now  """
# from django.core.files.storage import default_storage
# from celery import shared_task
# from celery_progress.backend import ProgressRecorder
# from app.utils.redis import remove_task_from_user_active_tasks, add_task_to_user_active_tasks
...
#     add_task_to_user_active_tasks(user_id=userid, task_id=import_drive_folder.request.id)
...
#     # now complete; remove this task id from session active tasks
#     remove_task_from_user_active_tasks(user_id=userid, task_id=import_drive_folder.request.id)
#     return result
